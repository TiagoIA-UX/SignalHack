      ...
      <main className="py-16">
        <Container>
          <div className="mx-auto max-w-lg">
            <Card className="p-6">
              <h1 className="text-xl font-semibold tracking-tight">Criar acesso</h1>
              <p className="mt-2 text-sm text-zinc-300">Sem senha. Só magic link.</p>
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-4">
                ...
                {status === "sent" ? (
                  <div className="text-sm text-zinc-300">Link enviado (em dev, aparece no console).</div>
                ) : null}
                {status === "error" ? (
